...
export function SettingsMenuList({ isMobile, onOpenChange, onSelectQuality, options, selectedLevel }: SettingsMenuListProps) {
  const menuClassName = `grid gap-[0.22rem] border shadow-[0_18px_40px_rgba(5,9,20,0.38)] ${
    isMobile
  ...
  const headerClassName = `text-xs font-semibold uppercase tracking-[0.06em] text-white/60 ${
    isMobile
